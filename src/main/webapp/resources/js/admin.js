...
function loadMapOrigin() {
   ...
   google.maps.event.addListener(searchBox, 'places_changed', function() {
      ...
      for (var i = 0, place; place = places[i]; i++) {
         ...
         /*
          * document.getElementById("title").value = marker.title; document.getElementById("lat").value =
          * marker.position.lat(); document.getElementById("long").value = marker.position.lng();
          */
...
function loadMapDestination() {

   var markers = [];
   var mapCanvas = document.getElementById('map-canvas-destination');
   var mapOptions = {
      scrollwheel : false,
      center : new google.maps.LatLng(-21.7351043, -63.2812499),
      zoom : 3,
